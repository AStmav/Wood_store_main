...
# Static files (CSS, JavaScript, Images)
# Ведущий "/" обязателен: иначе на /admin/ пути станут /admin/static/... и сломаются
STATIC_URL = '/static/'
...
from furniture_store.jazzmin import JAZZMIN_SETTINGS, JAZZMIN_UI_TWEAKS  # noqa: E402, F401